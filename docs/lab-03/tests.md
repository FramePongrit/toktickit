...
| MIG-01 | Migration | AC-11, BR-17, specification §9 | Upgraded Lab 2 fixture retains User IDs, Ticket IDs/numbers/requester links, Attachment metadata/files/uploader/remover links; IT Priority copied | `server/tests/lab-03/migration-seed.regression.test.ts` | Planned |
